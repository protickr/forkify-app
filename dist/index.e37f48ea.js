...
const controlAddRecipe = async function(newRecipeData) {
    try {
        ...
        await _modelJs.uploadRecipe(newRecipeData);
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHanlderUpdateServings(controlServings);
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>{
            ...
            const ingArr = ing[1].split(",").map((entry)=>entry.trim());
...
const KEY = `9558d0de-e7e2-4881-87e7-4f6521afaf14`;
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHanlderUpdateServings(handler) {
   ...
   */ render(data, render = true) {
    ...
    renderSpinner() {
        const markup = `
            <div class="spinner">
              <svg>
                <use href="${(0, _iconsSvgDefault.default)}/icons.svg#icon-loader"></use>
              </svg>
            </div>
      `;
        this._clear();
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        <button class="btn--inline pagination__btn--next" data-goto-page="${currentPage + 1}">
        ...
        <button class="btn--inline pagination__btn--prev" data-goto-page="${currentPage - 1}">
            <svg class="search__icon">
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire6d3a")
